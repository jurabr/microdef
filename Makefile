...
# desktop system (Gtk+):
ifeq ($(SYS_TYPE),IRIX)
CFLAGS=$(DEBUG) -D_OMAKO_ -DPOSIX -DGTKGUI -DPSGUI -DGDGUI -DFIGGUI -DBASGUI `pkg-config --cflags gtk+-2.0`  -DGDGUI -I/usr/include/gd #-I/usr/freeware/include/ #-I/sw/include
else
...
CFLAGS_CLI=$(DEBUG) -DMD_CLI -DPOSIX -DPSGUI -DFIGGUI
...
OBJECTS=mdunxio.o mdkernel.o md_gfx.o md_gtk.o md_gd.o md_ps.o md_fig.o md_bas.o
